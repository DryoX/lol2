...
module.exports.run = async (bot, message, args) => {
  ...
  .addField("**Public Command**", ["`report | Usage: report (name/id) (reason)`", "`ping | Usage: ping`", "`profile | Usage: profile`", "`serverinfo | Usage: serverinfo`", "`broadcast | Usage: brodcast (message)`", "`dog | Usage: dog`", "`cat | Usage: cat`", "`botinfo | Usage: botinfo`", "`8ball | Usage: 8ball (question)`"])
